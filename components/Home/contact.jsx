export default function Contact() {
  return (
    <main className="vh-100 d-flex justify-content-center align-items-center bg-primary">
      <section className="container row h-75">
        <div className="col-lg-8 h-100 justify-content-center">
          <h2>FOUND A BUG?</h2>
          <h5>
          ...
          <div className="d-flex flex-column h-50 col-md-8">
            <input
              type="text"
              className="c-size border border-dark rounded "
              placeholder="Email"
            />
            <textarea
              type="text"
              className="c-size border border-dark rounded h-100 my-2"
              placeholder="Message"
            />
