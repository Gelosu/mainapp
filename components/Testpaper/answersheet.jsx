...
<main className="container-fluid p-sm-4 py-3 h-100">
      <section>
        ...
        <ul className="d-flex flex-wrap justify-content-around mt-3 list-unstyled">
          <li className="m-0">TEST PAPER</li>
          <li className="m-0">ANSWER SHEET</li>
          <li className="m-0">ANSWER KEY</li>
          <li className="m-0">RECORDS</li>
        </ul>
        {/* CONTENT */}
        <section className="container-sm mt-5 col-xl-6 py-3 px-4 border border-dark rounded">
          ...
          <form className="row p-sm-2 px-3">
            <p className="col-sm-4 col-md-5 my-1 text-sm-start text-center">NUMBER OF CHOICES</p>
            <input type="number" className="col-sm-2 col-12 rounded border border-dark text-sm-start text-center" />
          </form>
          <form className="row p-sm-2 px-3">
            <p className="col-sm-4 my-1 text-sm-start text-center">
              PAGE ORIENTATION
